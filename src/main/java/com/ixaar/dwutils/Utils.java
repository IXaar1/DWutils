...
import com.ixaar.dwutils.handlers.LanguageHandler;
...
public class Utils {
    ...
    private static LanguageHandler lang;
    ...
    public static LanguageHandler getLang() {
        if (lang == null) {
            lang = new LanguageHandler("dwutils");
        }
        return lang;
    }
    ...
    public static Logger getLogger() {
        if (logger == null) {
            logger = LogManager.getFormatterLogger("dwutils");
        }
